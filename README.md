...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-15 08:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0c13fe53-f7bf-4259-aaa8-9fb2c32fb52a.git
$ cd 0c13fe53-f7bf-4259-aaa8-9fb2c32fb52a
```
